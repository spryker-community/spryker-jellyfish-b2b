 ...
 */
class OrderCommentJellyfishOrderExpanderPostMapPlugin extends AbstractPlugin implements JellyfishOrderExpanderPostMapPluginInterface
{
    /**
     * {@inheritDoc}
     *
    ...
    public function expand(
        ...
        return $this->getFacade()->expandJellyfishOrderWithOrderComment($jellyfishOrderTransfer, $spySalesOrder);
    }
}
